...
/*KONSTRUKTOR*/
void CreateItem(Item *I, char type, int tArrival, int tPerish, char lPickup, char lDropoff);
...
/* Mengembalikan true jika waktu sekarang sudah melebihi waktu pickup+waktup perish*/
